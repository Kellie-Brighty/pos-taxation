...
const Toast: React.FC<ToastProps> = ({ message, variant, onClose }) => {
  ...
  return (
    <div
      className={`fixed top-4 right-4 flex items-center p-4 mb-4 border-l-4 rounded-r-lg shadow-lg animate-slide-in ${getVariantStyles()}`}
      role="alert"
    >
      ...
      <button
        type="button"
        className={`ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex h-8 w-8 hover:bg-opacity-20 focus:ring-2 focus:ring-opacity-50
          ${
            variant === "success"
